...
<body class="bg-background-light dark:bg-background-dark font-display text-white min-h-screen">
    ...
    <nav class="flex-1 px-4 mt-4 space-y-1">
        ...
        <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-[#92adc9] hover:bg-[#233648] hover:text-white transition-colors" href="#">
    ...
    <main class="flex-1 overflow-y-auto">
        <main class="flex-1 overflow-y-auto">
        <!-- Top Navigation Bar -->
            <header class="sticky top-0 z-10 glass-card border-b border-[#233648] px-8 py-4 flex items-center justify-between">
               <div class="relative w-96">
               </div>
               <div class="flex items-center gap-4">
                <button class="p-2 text-[#92adc9] hover:text-white hover:bg-[#233648] rounded-lg transition-colors relative">
                <span class="material-symbols-outlined">notifications</span>
                <span class="absolute top-2 right-2 w-2 h-2 bg-primary rounded-full border-2 border-[#111a22]"></span>
                </button>
            ...
            <div class="p-8 max-w-6xl mx-auto space-y-8">
                  ...
                  <div class="flex flex-col md:flex-row items-center gap-6">
                     ...
                     <div class="text-center md:text-left">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
                           ...
                           <div class="flex items-center gap-2 text-sm bg-primary/10 text-primary px-3 py-1 rounded-full">
               ...
               <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
                  ...
                  <div class="space-y-4">
                     ...
                     <div class="space-y-3">
                        <!-- Book Item -->
                        <div class="glass-card p-4 rounded-xl flex items-center gap-4 hover:bg-[#2a3f55] transition-colors group">
                           <div class="h-20 w-14 rounded bg-cover bg-center shrink-0" data-alt="Cover of the book Project Hail Mary" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuBaZGPg-kil3_0H1XQh1HK6lUVgMoxnjihRl4g0MIeZIwLUEkBh8gZhSQLYhaXZjBjm8D9jiuqslsUdS2GEna4k_hq-2vnJxr5iYWnlwEtnBSzOCf3P4CycnmNms-26NYrMZn-KObx8IRpc2f_9_OtSTkJJVtED3SH1LaCB1IbKGTE6r5CDBxlRTG3HKPYmIWskUVZnkrgPcXF1RsjzR9TTrraxuBvJB3ReNzDAT01hFjKr-FWDP7Md__GWYvpsWDYtjYszHd8aVCfG");'></div>
                           <div class="flex-1 min-w-0">
                              <h4 class="font-bold truncate group-hover:text-primary transition-colors">Project Hail Mary</h4>
                           ...
                           <div class="flex flex-col gap-2">
                              <button class="p-2 bg-primary/10 text-primary hover:bg-primary hover:text-white rounded-lg transition-all" title="Return Book">
                        ...
                        <div class="glass-card p-4 rounded-xl flex items-center gap-4 hover:bg-[#2a3f55] transition-colors group">
                           ...
                           <div class="flex flex-col gap-2">
                              <button class="p-2 bg-amber-500/10 text-amber-500 hover:bg-amber-500 hover:text-white rounded-lg transition-all" title="Renew Book">
                        ...
                        <div class="glass-card p-4 rounded-xl flex items-center gap-4 group">
                           ...
                           <div class="flex-1 min-w-0">
                              ...
                              <div class="flex mt-1 text-[#92adc9]">
                                 <span class="text-[10px] font-medium px-2 py-0.5 rounded border border-[#324d67]">Not Rated</span>
                              </div>
                           </div>
