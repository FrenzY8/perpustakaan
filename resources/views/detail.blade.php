      ...
      <div class="lg:col-span-5 xl:col-span-4">
        <div
          ...
          <div class="w-full h-full bg-center bg-cover"
            style='background-image:url("https://lh3.googleusercontent.com/aida-public/AB6AXuCVmSYa1eDWWWJsWp3sNmFfbWmC-40EXjEM335Vfu80-L-pgpnMJnZaNA9XEdxsFAVeonbvoZiMMawGzfcwjD49uQDg7Md1E6uW0_8TBVar3_5nhuuq9N-Gc60XjrLzQGmXTinoEdWwZN8U68q8Gb_Obr0uQjQep302IHEeqfU9aHPUlU-9ZbcMabt1pFT7FTgUxD9hY1eNRLj5mzVdx5i2q9kEPLMd-gF2FZxheI9F5mfYV_-4svbdMh5sep-oootjUvqvflAqFCFc");'>
          </div>
          <div class="absolute bottom-6 left-6 z-20">
            <span class="bg-primary px-3 py-1 rounded-full text-xs font-bold tracking-wide uppercase shadow-lg">New
              Release</span>
          </div>
        </div>
      </div>
      ...
      <div class="lg:col-span-7 xl:col-span-8 space-y-8">
        <div class="space-y-4">
          <div class="flex flex-wrap items-center gap-4">
            <span
              class="px-3 py-1 bg-green-500/10 text-green-400 text-xs font-bold rounded-full border border-green-500/20 uppercase tracking-widest">In
              Stock</span>
        ...
        <div class="flex flex-wrap gap-4 pt-2">
          <button
            class="flex-1 md:flex-none md:min-w-[200px] h-14 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-lg shadow-primary/20">
            <span class="material-symbols-outlined">library_add_check</span>
            Borrow Now
          </button>
          <button
            class="flex-1 md:flex-none md:min-w-[200px] h-14 glass-panel hover:bg-white/10 text-white font-bold rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98]">
        ...
        <div class="space-y-4">
          ...
          <div class="glass-panel p-6 rounded-xl space-y-4 text-white/70 leading-relaxed font-light">
            <p>In "The Future of Mars," world-renowned planetary scientist Dr. Adrian Thorne presents a compelling
              blueprint for human colonization of the Red Planet.</p>
            <p>From atmospheric terraforming to the social structures of Martian cities, this book explores technology,
              ethics, and survival beyond Earth.</p>
          </div>
        </div>
